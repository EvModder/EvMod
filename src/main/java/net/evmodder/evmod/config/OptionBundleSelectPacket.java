...
public enum OptionBundleSelectPacket implements IConfigOptionListEntry {
	OFF("off", Main.MOD_ID+".gui.label.bundleSelectPacket.off"),
	NORMAL("normal", Main.MOD_ID+".gui.label.bundleSelectPacket.normal"),
	REVERSE("reverse", Main.MOD_ID+".gui.label.bundleSelectPacket.reverse");

	private final String configString;
	private final String translationKey;

	OptionBundleSelectPacket(String configString, String translationKey){
